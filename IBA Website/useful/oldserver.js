...
var completecocktail = setTimeout(createObjects, 1000);
...
setTimeout(createCompleteCocktail, 1000);
...
app.post("/*", function (req, res) {
    ...
    //console.log(string);
    fs.appendFileSync("feedbackform.log", string, "utf8");
    //fs.writeFileSync("feedbackform.txt", string, "utf8", {"flags":"a"});
    fs.appendFileSync("feedbackform.log", "\n", "utf8");
});
